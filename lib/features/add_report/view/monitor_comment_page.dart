          ...
          children: [
                    ...
                    SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextApp.subAppText(
                              widget.reportModel.reportDescription),
                        ],
                      ),
                    )
                  ],
            ...
            FormWidget(
                textForm: FormModel(
                    ...
                    invisible: false,
                    validator: (comment) => controller.vaildateComment(comment),
            ...
            Buttons.formscontainer(
                title: "Add comment",
                onTap: () => {
                      CommenttRepository().createComment(CommentModel(
                          userEmail: widget.reportModel.userEmail,
                          reportName: widget.reportModel.reportName,
                          date: widget.reportModel.date,
                          reportImage: widget.reportModel.reportImage,
                          reportDescription:
                              widget.reportModel.reportDescription,
                          reportLocation: widget.reportModel.reportLocation,
                          status: widget.reportModel.status,
